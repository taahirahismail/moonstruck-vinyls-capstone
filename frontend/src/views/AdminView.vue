                ...
                <table>
                    ...
                    <tbody v-for="user in users" :key="user.userID">
                        <tr v-if="users">
                            ...
                            <td>{{ user.userPass }}</td>
                            <td class="user-img">
                                <img :src="user.userImg" :alt="user.firstName"
                                loading="lazy"
                            ...
                            <td>
                                ...
                                <button class="btn del-btn" @click="deleteUser(user.userID)">Delete</button>
                            </td>
                        </tr>
                    ...
                    <tbody v-for="cart in orders" :key="cart.orderID">
                        <tr v-if="orders">
                            ...
                            <td>
                                ...
                                <button class="btn del-btn" @click="deleteOrder(cart.orderID)">Delete</button>
                            </td>
                        </tr>
